            ...
            switch (data.commandEvent)
            {
                ...
                case TSelectionCommands.SingleConfirmationByMouse:
                    if (!hom3r.state.selectionBlocked)
                    {
                        ...
                        {
                            hom3r.quickLinks.scriptsObject.GetComponent<SelectionManager>().ExecuteConfirmation(data.obj, false);
                        }
                    }
                    break;

                case TSelectionCommands.ConfirmationOff:
                    if (!hom3r.state.selectionBlocked) { hom3r.quickLinks.scriptsObject.GetComponent<SelectionManager>().ExecuteDesconfirmation(data.obj); }
                    break;
                ...
                case TSelectionCommands.MultipleConfirmation:
                    if (!hom3r.state.selectionBlocked)
                    {
                        if (data.obj.GetComponent<ObjectStateManager>() != null)
                        {
                            hom3r.quickLinks.scriptsObject.GetComponent<SelectionManager>().ExecuteConfirmation(data.obj, true);
                        }
                    }
                    break;
                ...
                case TSelectionCommands.SelectPart:
                    ...
                    //}
                    hom3r.quickLinks.scriptsObject.GetComponent<SelectionManager>().SelectPartFromInterface(data.partID, data.colour);
                    break;
